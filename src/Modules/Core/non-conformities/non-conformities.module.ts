...
@Module({
  imports: [TypeOrmModule.forFeature([require('./Entity/non-conformity.entity').NonConformity, require('./Entity/action-plan.entity').ActionPlan, require('./Entity/follow-up.entity').FollowUp, require('./Entity/why-record.entity').WhyRecord])],
